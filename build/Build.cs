...
class Build : NukeBuild
{
    ...
    [Parameter("Project Description")] readonly string ProjectDescription = "DynamoStudentManager Nuget Package built on " + DateTime.UtcNow.ToString("MM-dd-yyyy"); //default
    ...
    [Parameter("Project VCS Url")] readonly string ProjectUrl = "https://github.com/mtlucas/DynamoStudentManager"; //default
